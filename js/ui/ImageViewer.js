/**
 * Класс ImageViewer
 * Используется для взаимодействиея с блоком изображений
 * */
class ImageViewer {
 ...
 // Двойной клик по фотографии
    ...
    btnSelectAll.addEventListener('click', () => {
      ...
      imgList.forEach(elm => {
        elm.classList.toggle('selected', !imgSelected);
        this.checkButtonText();
      });
    });
  ...
  */
  ...
  checkButtonText() {
    ...
    if (imgSelected.every(elm => elm.classList.contains('selected'))) {
